/*
 * $Header: /cvsroot/wsplan/wsplan/src/org/mcm/sws/xmlschema/XSComplexContentExtension.java,v 1.2 2004/12/01 16:14:54 joepeer Exp $
...
public class XSComplexContentExtension extends XSDerivedContent {
	...
	throws javax.xml.soap.SOAPException {
		...
		XSType derivedFromType = parentSchema.getType(base);
		if(derivedFromType != null) {
			derivedFromType.instantiate(env, parentElem, values, currPath, encoding);
		}
